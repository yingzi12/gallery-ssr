      ...
      <q-item>
        ...
        <q-item-section >
          <q-item-label lines="1">
            <span class="text-weight-medium">这是图集的介绍，我是介绍哦，比儿科哦</span>
          </q-item-label>
          ...
          <q-item-label class="q-mt-xs text-body2 text-weight-bold text-primary text-uppercase">
            <span class="cursor-pointer"><a href="/users/addVedio">视频：0</a></span>
          </q-item-label>
          <q-item-label class="q-mt-xs text-body2 text-weight-bold text-primary text-uppercase">
            <span class="cursor-pointer"><a href="/users/addImage">照片：0</a></span>
          </q-item-label>
        </q-item-section>
        <q-item-section  side>
      ...
      <q-item>
        ...
        <q-item-section >
          ...
          <q-item-label lines="3" caption>
            这是图集的介绍，这是图集的介绍这是图集的介绍这是图集的介绍这是图集的介绍这是图集的介绍这是图集的介绍这是图集的介绍这是图集的介绍
            这是图集的介绍这是图集的介绍这是图集的介绍这是图集的介绍这是图集的介绍这是图集的介绍
          </q-item-label>
          <q-item-label caption>
            标签。标签标签标签标签标签标签标签标签标签标签标签标签
          </q-item-label>
          <q-item-label class="q-mt-xs text-body2 text-weight-bold text-primary text-uppercase">
            <span class="cursor-pointer">视频：0</span>
          </q-item-label>
          <q-item-label class="q-mt-xs text-body2 text-weight-bold text-primary text-uppercase">
            <span class="cursor-pointer">照片：0</span>
          </q-item-label>
        </q-item-section>
        <q-item-section  side>
          <q-btn class="gt-xs" size="12px" flat dense round icon="delete" >vip</q-btn>
          <q-btn class="gt-xs" size="12px" flat dense round icon="done"> 免费 </q-btn>
        </q-item-section>
